...
const FolderIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M5.3763 5.66784C5.55975 5.46145 5.87579 5.44286 6.08218 5.62632L8.33218 7.62632C8.43893 7.7212 8.5 7.85721 8.5 8.00002C8.5 8.14284 8.43893 8.27884 8.33218 8.37373L6.08218 10.3737C5.87579 10.5572 5.55975 10.5386 5.3763 10.3322C5.19284 10.1258 5.21143 9.80978 5.41782 9.62632L6.6849 8.50002H0.5C0.223858 8.50002 0 8.27617 0 8.00002C0 7.72388 0.223858 7.50002 0.5 7.50002H6.6849L5.41782 6.37373C5.21143 6.19027 5.19284 5.87423 5.3763 5.66784Z"
      fill="#A2AAB5"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2.29289 1.29169C2.48043 1.10416 2.73478 0.9988 3 0.9988H6.33331C6.5482 0.999684 6.75716 1.06934 6.9296 1.19757L6.93079 1.19845L8.6671 2.99879L8.6706 3.00002H14C14.2652 3.00002 14.5196 3.10538 14.7071 3.29291C14.8946 3.48045 15 3.7348 15 4.00002V13.0563C15 13.3066 14.9006 13.5466 14.7236 13.7236C14.5466 13.9006 14.3065 14 14.0562 14H3C2.73478 14 2.48043 13.8947 2.29289 13.7071C2.10536 13.5196 2 13.2652 2 13V10.4C2 10.1791 2.17909 10 2.4 10H2.6C2.82091 10 3 10.1791 3 10.4V13H14V4.00002H8.66669C8.4518 3.99914 8.24284 3.92948 8.0704 3.80125L8.06921 3.80036L6.3329 2.00003L6.3294 1.9988H3V5.60002C3 5.82093 2.82091 6.00002 2.6 6.00002H2.40001C2.1791 6.00002 2.00001 5.82093 2.00001 5.60002L2 1.9988C2 1.73358 2.10536 1.47923 2.29289 1.29169Z"
      fill="#A2AAB5"
    />
  </svg>
);
...
const ClockIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M8.00004 4.03162C7.7239 4.03162 7.50004 4.25547 7.50004 4.53162V8.53162C7.50004 8.68646 7.57043 8.82487 7.68095 8.91658C7.70485 8.9429 7.73163 8.97059 7.76144 8.99982L9.6822 10.9206C9.87746 11.1158 10.194 11.1158 10.3893 10.9206C10.5846 10.7253 10.5846 10.4087 10.3893 10.2135L8.50004 8.3242V4.53162C8.50004 4.25547 8.27618 4.03162 8.00004 4.03162Z"
      fill="#A2AAB5"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 14.5C11.5899 14.5 14.5 11.5899 14.5 8C14.5 4.41015 11.5899 1.5 8 1.5C4.41015 1.5 1.5 4.41015 1.5 8C1.5 11.5899 4.41015 14.5 8 14.5ZM8 15.5C12.1421 15.5 15.5 12.1421 15.5 8C15.5 3.85786 12.1421 0.5 8 0.5C3.85786 0.5 0.5 3.85786 0.5 8C0.5 12.1421 3.85786 15.5 8 15.5Z"
      fill="#A2AAB5"
    />
  </svg>
);

const FullCoverageIcon = () => (
  <svg
    width="16"
    height="16"
    viewBox="0 0 16 16"
  ...
  >
    ...
    />
    <path
      d="M3 3.5C3 3.22386 3.22386 3 3.5 3H12.5C12.7761 3 13 3.22386 13 3.5V12.5C13 12.7761 12.7761 13 12.5 13H3.5C3.22386 13 3 12.7761 3 12.5V3.5Z"
      fill="#A2AAB5"
    />
  </svg>
);

const PartialCoverageIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.5 12C11.7761 12 12 11.7761 12 11.5V2L2 12H11.5Z"
      fill="#A2AAB5"
    />
  </svg>
);
...
const TagIcon = () => (
  <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M11.5962 0.5H11.1933C10.1679 0.5 9.18169 0.893774 8.43829 1.6L1.1225 8.55C0.292501 9.3385 0.2925 10.6615 1.1225 11.45L8.43829 18.4C9.18169 19.1062 10.1679 19.5 11.1933 19.5H11.5962"
      stroke="#C1C7D0"
    />
  </svg>
);
...
const StatusIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M1.5 10L8.00018 6.09976L14.5 10"
      stroke="#DC5959"
      strokeWidth="2.8"
      strokeLinecap="round"
    />
...
const generateBreadcrumbs = (count: number) =>
  Array.from({ length: count }, (_, i) => ({
    title: 'Folder Name',
    link: { pathname: `/folder-${i + 1}` },
  }));

const mockData = {
  breadcrumbs: generateBreadcrumbs(6),
  header: {
    title: 'Login Process Evaluation Zeta',
    version: '1.0 Stable GTX',
    availableCount: 9,
  ...
  automationCoverage: {
    fullCoverageTest: {
      id: 'TCID-2023',
      title: 'Complete scenario validation',
    },
    partialCoverageTests: [
      { id: 'TCID-3372', title: 'User login validation' },
      { id: 'TCID-1122', title: 'Password Reset Functionality Test' },
    ],
  },
  tags: [
    'ui bug',
    'performance test',
    'ios functionality ve...',
    'security check',
    'battery performanc...',
    'cross-platform effi...',
    'user flow',
  ...
  scenario: {
    precondition:
      'Ideally you should have a test method for each separate unit of work so you can always immediately view where things are going wrong. In this example there is a basic method called getUserById() which will return a user and there...',
  },
};
            ...
            <div className="content-wrapper">
              <div>
                <div
                  ...
                  onClick={() => setAutomationCoverageExpanded(!automationCoverageExpanded)}
                >
                  <div className="section-header-left">
                    <span
                      className={`section-expand-icon ${automationCoverageExpanded ? 'expanded' : 'collapsed'}`}
                    >
                  ...
                  <Button
                    ...
                    className="bind-autotest-button"
                  >
                  ...
                  <>
                    <div className="automation-coverage-content">
                      <div className="coverage-section">
                        <div
                          key={mockData.automationCoverage.fullCoverageTest.id}
                          className="test-card"
                        >
                    ...
                    <div className="coverage-section">
                      <div className="test-card">
                        <div className="coverage-header">
                          ...
                          <button
                            type="button"
                            className="partial-toggle-button"
                            onClick={() => setPartialTestsExpanded(!partialTestsExpanded)}
                          >
                            <span>PARTIAL IN TOTAL</span>
                            <span
                              className={`toggle-icon ${partialTestsExpanded ? 'expanded' : ''}`}
                            >
                              <ChevronDownDropdownIcon />
                            </span>
                          </button>
                        </div>
                        {partialTestsExpanded && (
                          <div className="test-cards">
                            {mockData.automationCoverage.partialCoverageTests.map((test, index) => (
                              <div key={index} className="test-card-content">
                                <div className="test-card-content-left">
              ...
              <div>
                <div className="section-header" onClick={() => setTagsExpanded(!tagsExpanded)}>
                  <div className="section-header-left">
                    <span
                      className={`section-expand-icon ${tagsExpanded ? 'expanded' : 'collapsed'}`}
                    >
                      <ChevronDownDropdownIcon />
                    </span>
              ...
              <div>
                ...
                >
                  <div className="section-header-left">
                    <span
                      className={`section-expand-icon ${scenarioExpanded ? 'expanded' : 'collapsed'}`}
                    >
                      <ChevronDownDropdownIcon />
                    </span>
...
const INITIAL_FILTERS = {
  ...
  defectType: '',
  startTime: 'Any',
  testDescOperator: 'Contains',
  testDescription: '',
  defectCommentOperator: 'Contains',
  defectComment: '',
  issueOperator: 'All',
  issueBTS: '',
  methodType: '',
            ...
            <div className="filter-content">
              ...
              <div className="filter-field">
                ...
                <Dropdown
                  ...
                  onChange={updateFilter('defectType')}
                  options={FILTER_OPTIONS.defectType}
              ...
              <div className="filter-field">
                ...
                <Dropdown
                  ...
                  onChange={updateFilter('startTime')}
                  options={FILTER_OPTIONS.startTime}
                />
              </div>
              ...
              <div className="filter-field">
                ...
                <div className="filter-field-group">
                  <Dropdown
                    value={filters.testDescOperator}
                    onChange={updateFilter('testDescOperator')}
                    options={FILTER_OPTIONS.textOperator}
                    className="operator-dropdown"
                  />
                  <FieldText
                    className="group-field-text"
                    value={filters.testDescription}
                    onChange={(e) => updateFilter('testDescription')(e.target.value)}
              ...
              <div className="filter-field">
                ...
                <div className="filter-field-group">
                  <Dropdown
                    value={filters.defectCommentOperator}
                    onChange={updateFilter('defectCommentOperator')}
                    options={FILTER_OPTIONS.textOperator}
                    className="operator-dropdown"
                  />
                  <FieldText
                    className="group-field-text"
                    value={filters.defectComment}
                    onChange={(e) => updateFilter('defectComment')(e.target.value)}
              ...
              <div className="filter-field">
                ...
                <div className="filter-field-group">
                  <Dropdown
                    value={filters.issueOperator}
                    onChange={updateFilter('issueOperator')}
                    options={FILTER_OPTIONS.issueOperator}
                    className="operator-dropdown"
                  />
                  <FieldText
                    className="group-field-text"
                    value={filters.issueBTS}
                    onChange={(e) => updateFilter('issueBTS')(e.target.value)}
                    placeholder="Enter issue in BTS"
                  />
                </div>
              </div>
              ...
              <div className="filter-field">
                ...
                <Dropdown
                  ...
                  onChange={updateFilter('methodType')}
                  options={FILTER_OPTIONS.methodType}
              ...
              <div className="filter-field">
                ...
                <Dropdown
                  value={filters.retry}
                  onChange={updateFilter('retry')}
                  options={FILTER_OPTIONS.retry}
              ...
              <div className="filter-field">
                ...
                <Dropdown
                  ...
                  onChange={updateFilter('patternName')}
                  options={FILTER_OPTIONS.pattern}
