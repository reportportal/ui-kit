...
) => Partial<StateChangeOptions<T>>`,signature:{arguments:[{type:{name:"DownshiftState",elements:[{name:"T"}],raw:"DownshiftState<T>"},name:"state"},{type:{name:"StateChangeOptions",elements:[{name:"T"}],raw:"StateChangeOptions<T>"},name:"changes"}],return:{name:"Partial",elements:[{name:"StateChangeOptions",elements:[{name:"T"}],raw:"StateChangeOptions<T>"}],raw:"Partial<StateChangeOptions<T>>"}}},description:""},useFixedPositioning:{required:!0,tsType:{name:"boolean"},description:""},getUniqKey:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: T) => string",signature:{arguments:[{type:{name:"T"},name:"item"}],return:{name:"string"}}},description:""},customEmptyListMessage:{required:!1,tsType:{name:"string"},description:""},customNoMatchesMessage:{required:!1,tsType:{name:"string"},description:""},newItemButtonText:{required:!1,tsType:{name:"string"},description:""}}};const R=[{id:"Demo Api Tests",name:"Demo Api Tests"},{id:"Demo Api Tests 1",name:"Demo Api Tests 1"},{id:"Demo Api Tests 2",name:"Demo Api Tests 2"},{id:"Demo Api Tests 3",name:"Demo Api Tests 3"}],F=["Demo Api Tests","Demo Api Tests 1","Demo Api Tests 2","Demo Api Tests 3"],Se={options:R,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e!=null&&e.id?String(e==null?void 0:e.id):"",value:R[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",isDropdownMode:!0,disabled:!1,inputProps:{clearable:!0},maxLength:null},J={options:F,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e?String(e):"",value:F[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",disabled:!1,inputProps:{clearable:!0},maxLength:null},Ve={title:"Controls/Autocompletes/SingleAutocomplete",component:C,parameters:{...J},tags:["autodocs"]},S={args:{...Se},render:e=>{const[r,o]=V.useState(e.value||{}),p={...e,inputProps:{...e.inputProps,onClear:()=>o({})}},m=(s,n)=>{switch(n.type){case g.stateChangeTypes.keyDownEnter:case g.stateChangeTypes.clickItem:return{...n,highlightedIndex:s.highlightedIndex,inputValue:""};default:return n}},l=s=>{o(s)};return t.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:t.jsx(C,{...p,onChange:l,stateReducer:m,value:r})})}},w={args:{...J},render:e=>{const[r,o]=V.useState(e.value||""),p={...e,inputProps:{...e.inputProps,onClear:()=>o("")}},m=(s,n)=>{switch(n.type){case g.stateChangeTypes.keyDownEnter:case g.stateChangeTypes.clickItem:return{...n,highlightedIndex:s.highlightedIndex,inputValue:""};default:return n}},l=s=>{o(s)};return t.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:t.jsx(C,{...p,onChange:l,stateReducer:m,value:r})})}};var L,M,j;S.parameters={...S.parameters,docs:{...(L=S.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    ...TEST_DATA_OBJECTS
  },
  render: args => {
...
}`,...(k=(B=w.parameters)==null?void 0:B.docs)==null?void 0:k.source}}};const Je=["SingleSelectObjects","SingleSelectStrings"];export{S as SingleSelectObjects,w as SingleSelectStrings,Je as __namedExportsOrder,Ve as default};
