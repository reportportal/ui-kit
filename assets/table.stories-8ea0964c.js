...
<Table
  ...
  // ... other props
/>`})]})]})},De={render:()=>i.jsx(Cr,{})},Te={render:e=>i.jsxs("div",{style:{minWidth:"600px"},children:[i.jsx("h3",{style:{margin:"0 0 16px 0",fontSize:"16px",color:"#333"},children:"Resizable Columns (Default Constraints)"}),i.jsxs("p",{style:{margin:"0 0 16px 0",fontSize:"14px",color:"#666"},children:["Drag the column borders in the header to adjust widths. Default constraints:"," ",i.jsx("code",{children:"minColumnWidth=50"}),", ",i.jsx("code",{children:"maxColumnWidth=500"})]}),i.jsx(N,{...e,primaryColumn:I,data:he,fixedColumns:Oe})]}),args:{renderRowActions:J,isResizable:!0}},Ee={render:e=>i.jsx("div",{style:{minWidth:"600px"},children:i.jsx(N,{...e,primaryColumn:I,data:he,fixedColumns:Oe})}),args:{isResizable:!0}},ze={render:e=>i.jsxs("div",{style:{minWidth:"600px"},children:[i.jsx("h3",{style:{margin:"0 0 16px 0",fontSize:"16px",color:"#333"},children:"Resizable Columns (Custom Constraints)"}),i.jsxs("p",{style:{margin:"0 0 16px 0",fontSize:"14px",color:"#666"},children:["Columns can be resized between 80px and 300px. Custom constraints:"," ",i.jsx("code",{children:"minColumnWidth=80"}),", ",i.jsx("code",{children:"maxColumnWidth=300"})]}),i.jsx(N,{...e,primaryColumn:I,data:he,fixedColumns:Oe})]}),args:{renderRowActions:J,isResizable:!0,minColumnWidth:80,maxColumnWidth:300}},_e={render:e=>i.jsx("div",{style:{width:"900px",height:"400px",border:"1px solid #ccc",padding:"16px"},children:i.jsx("div",{style:{height:"calc(100% - 16px)",position:"relative"},children:i.jsx(N,{...e,data:Ne,primaryColumn:I,fixedColumns:lt})})}),args:{renderRowActions:J,isResizable:!0,isHeaderFixed:!0}},Ae={render:e=>i.jsx("div",{style:{width:"600px",height:"500px",border:"1px solid #ccc",padding:"16px"},children:i.jsx("div",{style:{height:"calc(100% - 16px)",position:"relative"},children:i.jsx(N,{...e,data:X,primaryColumn:ne,fixedColumns:ge,isHorizontallyScrollable:!0,isHeaderFixed:!0})})}),args:{renderRowActions:J,isResizable:!0}},je={render:e=>i.jsx("div",{style:{width:"900px",height:"500px",border:"1px solid #ccc",padding:"16px"},children:i.jsx("div",{style:{height:"calc(100% - 16px)",position:"relative"},children:i.jsx(N,{...e,data:Ne,primaryColumn:I,fixedColumns:lt,pinnedColumnKeys:["name","email"],isHorizontallyScrollable:!0,isHeaderFixed:!0})})}),args:{renderRowActions:J,isResizable:!0}},Pe={render:e=>{const t=h.useRef(null),[n,o]=h.useState({key:ne[0].key,direction:oe}),[a,s]=h.useState(ne[0]),[r,u]=h.useState(oe),d=h.useMemo(()=>{const y=[...X];for(let w=0;w<3;w++)y.push(...X.map(T=>({...T,id:`${T.id}-copy-${w+1}`})));return y},[]),l=fe(d,n),[m,g]=h.useState(l),[p,f]=h.useState(new Set([]));return h.useEffect(()=>{const{key:y,direction:w}=n,T=[...ge,...ne].find(S=>S.key===y);u(w),s(T)},[n]),i.jsxs("div",{style:{width:"800px",height:"600px",border:"1px solid #ccc",padding:"16px"},children:[i.jsx("h3",{style:{margin:"0 0 16px 0"},children:"Table with Horizontal Scroll + Pinned Header (External Scroll Container)"}),i.jsx("p",{style:{margin:"0 0 16px 0",fontSize:"14px",color:"#666"},children:"This example demonstrates a pinned header that activates when scrolling in an external container. The table header pins to the top when the scroll position reaches it. Scroll vertically in the container to see the header pinning, and horizontally to see pinned columns and gradient effects."}),i.jsxs("div",{ref:t,style:{height:"calc(100% - 100px)",overflowY:"auto",overflowX:"hidden",position:"relative"},children:[i.jsxs("div",{style:{padding:"16px",backgroundColor:"#f0f0f0",marginBottom:"16px"},children:[i.jsx("h4",{style:{margin:"0 0 8px 0",fontSize:"16px"},children:"Content Above Table"}),i.jsx("p",{style:{margin:"0",fontSize:"14px",color:"#666"},children:"This content is inside the scrollable container. When you scroll down, this text will move up and disappear, but the table header will stick to the top."}),i.jsx("p",{style:{margin:"8px 0 0",fontSize:"14px",color:"#666"},children:"Scroll down to see the header pinning effect. The table header will remain fixed at the top while this content scrolls away."})]}),i.jsx(N,{...e,data:m,primaryColumn:ne,fixedColumns:ge,isHeaderFixed:!0,isHorizontallyScrollable:!0,pinnedColumnKeys:["name","email"],externalScrollContainerRef:t,sortableColumns:[ne[0].key,"department","status"],onChangeSorting:(y=n)=>{let{direction:w}=y;const{key:T}=y;w=Yt(w);const S=fe(m,{key:T,direction:w});o({key:T,direction:w}),g(S)},onToggleRowSelection:y=>{const w=new Set(p);w.has(y)?w.delete(y):w.add(y),f(w)},onToggleAllRowsSelection:()=>{if(p.size===d.length)f(new Set);else{const y=new Set(d.map(w=>w.id));f(y)}},selectedRowIds:[...p],sortingColumn:a,sortingDirection:r})]})]})},args:{selectable:!0,renderRowActions:J}},Me={render:e=>{const[t,n]=h.useState(new Set([])),[o,a]=h.useState(new Set([]));return i.jsx("div",{style:{width:"600px",height:"500px",border:"1px solid #ccc",padding:"16px",paddingLeft:"48px"},children:i.jsx("div",{style:{height:"calc(100% - 16px)",position:"relative"},children:i.jsx(N,{...e,data:X,primaryColumn:ne,fixedColumns:ge,expandedRowIds:[...o],selectedRowIds:[...t],onToggleRowSelection:s=>{const r=new Set(t);r.has(s)?r.delete(s):r.add(s),n(r)},onToggleAllRowsSelection:()=>{if(t.size===X.length)n(new Set);else{const s=new Set(X.map(r=>r.id));n(s)}},onToggleRowExpansion:s=>{const r=new Set(o);r.has(s)?r.delete(s):r.add(s),a(r)},onToggleAllRowsExpansion:()=>{if(o.size===X.length)a(new Set);else{const s=new Set(X.map(r=>r.id));a(s)}}})})})},args:{renderRowActions:J,isResizable:!0,isHeaderFixed:!0,isHorizontallyScrollable:!0,pinnedColumnKeys:["name","email"],selectable:!0,isRowsExpandable:!0,isCheckboxOutside:!0}};var jn,Pn,Mn;Ze.parameters={...Ze.parameters,docs:{...(jn=Ze.parameters)==null?void 0:jn.docs,source:{originalSource:`{
...
}`,...(Qn=(Jn=st.parameters)==null?void 0:Jn.docs)==null?void 0:Qn.source}}};var Zn,eo,to,no,oo;Re.parameters={...Re.parameters,docs:{...(Zn=Re.parameters)==null?void 0:Zn.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => {
    // eslint-disable-next-line react-hooks/rules-of-hooks
...
}`,...(to=(eo=Re.parameters)==null?void 0:eo.docs)==null?void 0:to.source},description:{story:`Demonstrates all row sizes (small: 44px, default: 64px, large: 80px) with expandable content.
Useful for testing that row heights behave correctly when expanding/collapsing cells with long text.`,...(oo=(no=Re.parameters)==null?void 0:no.docs)==null?void 0:oo.description}}};var ao,so,ro,io,lo;ke.parameters={...ke.parameters,docs:{...(ao=ke.parameters)==null?void 0:ao.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ro=(so=ke.parameters)==null?void 0:so.docs)==null?void 0:ro.source},description:{story:`Simple demonstration of row sizes without expand functionality.
...
- **large**: 80px height - for tables with more visual prominence`,...(lo=(io=ke.parameters)==null?void 0:io.docs)==null?void 0:lo.description}}};var co,uo,po,ho,mo;De.parameters={...De.parameters,docs:{...(co=De.parameters)==null?void 0:co.docs,source:{originalSource:`{
  render: () => <CustomHeaderDemo />
}`,...(po=(uo=De.parameters)==null?void 0:uo.docs)==null?void 0:po.source},description:{story:`Demonstrates how to customize the table header background color using CSS.
...
for example, using a gray header on a white background or vice versa.`,...(mo=(ho=De.parameters)==null?void 0:ho.docs)==null?void 0:mo.description}}};var fo,go,wo,xo,yo;Te.parameters={...Te.parameters,docs:{...(fo=Te.parameters)==null?void 0:fo.docs,source:{originalSource:`{
...
}`,...(wo=(go=Te.parameters)==null?void 0:go.docs)==null?void 0:wo.source},description:{story:`Demonstrates resizable columns with default constraints (min: 50px, max: 500px).

Users can drag the column borders in the header to adjust column widths.
Initial widths are taken from column.width property.`,...(yo=(xo=Te.parameters)==null?void 0:xo.docs)==null?void 0:yo.description}}};var bo,So,vo,Co,Ro;Ee.parameters={...Ee.parameters,docs:{...(bo=Ee.parameters)==null?void 0:bo.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => <div style={{
    minWidth: '600px'
  }}>
      <Table {...args} primaryColumn={primaryColumns} data={data} fixedColumns={fixedColumns} />
...
}`,...(vo=(So=Ee.parameters)==null?void 0:So.docs)==null?void 0:vo.source},description:{story:"Demonstrates resizable columns without row actions.",...(Ro=(Co=Ee.parameters)==null?void 0:Co.docs)==null?void 0:Ro.description}}};var ko,Do,To,Eo,zo;ze.parameters={...ze.parameters,docs:{...(ko=ze.parameters)==null?void 0:ko.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => <div style={{
    minWidth: '600px'
  }}>
      <h3 style={{
...
}`,...(To=(Do=ze.parameters)==null?void 0:Do.docs)==null?void 0:To.source},description:{story:`Demonstrates resizable columns with custom min/max constraints.

Columns can be resized between 80px and 300px.`,...(zo=(Eo=ze.parameters)==null?void 0:Eo.docs)==null?void 0:zo.description}}};var _o,Ao,jo,Po,Mo;_e.parameters={..._e.parameters,docs:{...(_o=_e.parameters)==null?void 0:_o.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => <div style={{
    width: '900px',
    height: '400px',
    border: '1px solid #ccc',
...
}`,...(jo=(Ao=_e.parameters)==null?void 0:Ao.docs)==null?void 0:jo.source},description:{story:"Demonstrates resizable columns with fixed header.",...(Mo=(Po=_e.parameters)==null?void 0:Po.docs)==null?void 0:Mo.description}}};var No,Oo,Ho,Wo,Lo;Ae.parameters={...Ae.parameters,docs:{...(No=Ae.parameters)==null?void 0:No.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => <div style={{
    width: '600px',
    height: '500px',
    border: '1px solid #ccc',
...
}`,...(Ho=(Oo=Ae.parameters)==null?void 0:Oo.docs)==null?void 0:Ho.source},description:{story:"Demonstrates resizable columns with horizontal scroll and fixed header.",...(Lo=(Wo=Ae.parameters)==null?void 0:Wo.docs)==null?void 0:Lo.description}}};var $o,Fo,Bo,Io,qo;je.parameters={...je.parameters,docs:{...($o=je.parameters)==null?void 0:$o.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => <div style={{
    width: '900px',
    height: '500px',
    border: '1px solid #ccc',
...
}`,...(Bo=(Fo=je.parameters)==null?void 0:Fo.docs)==null?void 0:Bo.source},description:{story:"Demonstrates resizable columns with pinned columns.",...(qo=(Io=je.parameters)==null?void 0:Io.docs)==null?void 0:qo.description}}};var Uo,Yo,Vo,Xo,Go;Pe.parameters={...Pe.parameters,docs:{...(Uo=Pe.parameters)==null?void 0:Uo.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => {
    // eslint-disable-next-line react-hooks/rules-of-hooks
...
}`,...(Vo=(Yo=Pe.parameters)==null?void 0:Yo.docs)==null?void 0:Vo.source},description:{story:`Demonstrates a table with pinned header when scrolling is handled by an external container.
...
pinned columns and gradients.`,...(Go=(Xo=Pe.parameters)==null?void 0:Xo.docs)==null?void 0:Go.description}}};var Ko,Jo,Qo,Zo,ea;Me.parameters={...Me.parameters,docs:{...(Ko=Me.parameters)==null?void 0:Ko.docs,source:{originalSource:`{
  render: (args: TableComponentProps) => {
    // eslint-disable-next-line react-hooks/rules-of-hooks
    const [checkedRows, setCheckedRows] = useState<Set<number | string>>(new Set([]));
    // eslint-disable-next-line react-hooks/rules-of-hooks
...
}`,...(Qo=(Jo=Me.parameters)==null?void 0:Jo.docs)==null?void 0:Qo.source},description:{story:"Demonstrates resizable columns with horizontal scroll and checkbox outside.",...(ea=(Zo=Me.parameters)==null?void 0:Zo.docs)==null?void 0:ea.description}}};const qr=["Default","FixedHeader","HorizontalScrollWithFixedHeaderControl","PinnedColumnsWithFixedHeader","ExpandableRows","ExpandableRowsWithDefaultState","CellExpansion","RowSizesWithExpand","RowSizes","CustomHeaderStyle","ResizableColumns","ResizableColumnsWithoutActions","ResizableColumnsWithConstraints","ResizableColumnsWithFixedHeader","ResizableColumnsWithHorizontalScroll","ResizableColumnsWithPinnedColumns","HorizontalScrollWithPinnedHeader","ResizableColumnsWithCheckboxOutside"];export{st as CellExpansion,De as CustomHeaderStyle,Ze as Default,ot as ExpandableRows,at as ExpandableRowsWithDefaultState,et as FixedHeader,tt as HorizontalScrollWithFixedHeaderControl,Pe as HorizontalScrollWithPinnedHeader,nt as PinnedColumnsWithFixedHeader,Te as ResizableColumns,Me as ResizableColumnsWithCheckboxOutside,ze as ResizableColumnsWithConstraints,_e as ResizableColumnsWithFixedHeader,Ae as ResizableColumnsWithHorizontalScroll,je as ResizableColumnsWithPinnedColumns,Ee as ResizableColumnsWithoutActions,ke as RowSizes,Re as RowSizesWithExpand,qr as __namedExportsOrder,Ir as default};
