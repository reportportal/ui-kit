import{j as t}from"./jsx-runtime-2f188e98.js";import{c as ye}from"./bind-d8141dee.js";import{D as T}from"./downshift.esm-ce98d9a3.js";import{u as Se}from"./floating-ui.react-60d1f04e.js";import{F as we}from"./fieldText-86ee05b0.js";import{r as W}from"./index-3553ef47.js";import{S as Ce}from"./dropdown-1f4530a4.js";import{E as Pe,A as Ie,T as xe}from"./constants-7da14de3.js";import{i as Ae}from"./isEmpty-6ac0b123.js";import{b as be}from"./floating-ui.react-dom-a94e415a.js";import"./index-4c891f75.js";import"./tslib.es6-e2fc4f1b.js";import"./index-d0bd1ed5.js";import"./clear-c7bc24e5.js";import"./openEye-28d4aa93.js";import"./baseIconButton-9b03f096.js";import"./spinLoader-d5daab2a.js";import"./maxValueDisplay-a537ac0f.js";import"./fieldLabel-917daddd.js";import"./index-5cf2ac00.js";import"./bubblesLoader-539cf135.js";import"./button-a3e8ccfc.js";import"./plus-150a0ce8.js";const De={"input-wrapper":"_input-wrapper_d9vma_1","dropdown-button":"_dropdown-button_d9vma_6","icon-reversed":"_icon-reversed_d9vma_14"},j=ye.bind(De),Oe=0,A=e=>{const{options:i=[],value:r,placeholder:m="",onChange:u=()=>{},onFocus:d=()=>{},onBlur:s=()=>{},disabled:n=!1,inputProps:Y={},parseValueToString:f=o=>o===null?"":String(o),minLength:E=1,skipOptionCreation:X=!1,maxLength:$=null,optionVariant:z="",isRequired:Q=!1,error:Z="",touched:ee=!1,setTouch:l=()=>{},createWithoutConfirmation:_=!1,menuClassName:te="",icon:q,isDropdownMode:c=!1,isOptionUnique:b,refFunction:ne,stateReducer:ae,onStateChange:re,useFixedPositioning:se,newItemButtonText:oe="",...ie}=e,{refs:N,floatingStyles:pe}=Se({placement:"bottom-start",strategy:se?"fixed":"absolute",whileElementsMounted:be}),le=(o,g,y)=>({item:h,index:S,...p})=>o({item:h,index:S,isSelected:y!==null&&y===h,...p,isActive:g===S}),me=(o,g)=>{o.key===xe&&(o.preventDefault(),g(i.length))};return t.jsx(T,{onChange:u,itemToString:f,selectedItem:r,onStateChange:re,defaultHighlightedIndex:Oe,stateReducer:ae,children:({getInputProps:o,getItemProps:g,setHighlightedIndex:y,toggleMenu:h,openMenu:S,isOpen:p,inputValue:D,highlightedIndex:ue,getRootProps:de,selectItem:w})=>{const R=de(void 0,{suppressRefError:!0}),ce={...R,ref:a=>(N.setReference(a),R.ref(a))},ge=D??"",{onClear:C,clearable:he,...Te}=Y,F=he&&r!==null,fe=(...a)=>{w(null),C==null||C(...a)};return t.jsx(t.Fragment,{children:t.jsxs("div",{className:j("input-wrapper"),...ce,children:[t.jsx(we,{...o({placeholder:n?"":m,maxLength:$||void 0,onFocus:()=>{c&&!p&&(S(),l==null||l(!0)),d()},ref:ne,onKeyDown:a=>{a.key===Pe&&a.preventDefault(),D&&p&&me(a,y)},onBlur:a=>{const P=ge.trim(),O=!Ae(P),L=O?i.find(v=>f(v)===P):void 0;w(L||(!X&&_&&O?P:null)),s(a),b==null||b(O?!i.some(v=>f(v)===P):null),c&&p&&h(),l==null||l(!0)},disabled:n,defaultWidth:!1,isRequired:Q,touched:ee,error:Z,...Te,clearable:F,onClear:F?fe:C,endIcon:c&&!q?t.jsx("button",{type:"button",className:j("dropdown-button",{"icon-reversed":p}),onClick:()=>h(),"aria-label":"Toggle dropdown","aria-expanded":p,children:t.jsx(Ce,{})}):q,minLength:c?0:E})}),t.jsx(Ie,{isOpen:p,isDropdownMode:c,style:pe,ref:N.setFloating,minLength:E,inputValue:(D||"").trim(),getItemProps:le(g,ue,r),parseValueToString:f,optionVariant:z,createWithoutConfirmation:_,className:te,options:i,newItemButtonText:oe,...ie})]})})}})};A.__docgenInfo={description:"",methods:[],displayName:"SingleAutocomplete",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:""},onStateChange:{required:!0,tsType:{name:"ComponentProps['onStateChange']",raw:"ComponentProps<typeof Downshift<T>>['onStateChange']"},description:""},value:{required:!0,tsType:{name:"union",raw:"T | null",elements:[{name:"T"},{name:"null"}]},description:""},placeholder:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"ComponentProps['onChange']",raw:"ComponentProps<typeof Downshift<T>>['onChange']"},description:""},onFocus:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onBlur:{required:!0,tsType:{name:"signature",type:"function",raw:"(e: FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"FocusEvent",elements:[{name:"HTMLInputElement"}],raw:"FocusEvent<HTMLInputElement>"},name:"e"}],return:{name:"void"}}},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},inputProps:{required:!1,tsType:{name:"ComponentProps",elements:[{name:"FieldText"}],raw:"ComponentProps<typeof FieldText>"},description:""},parseValueToString:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: T | null) => string",signature:{arguments:[{type:{name:"union",raw:"T | null",elements:[{name:"T"},{name:"null"}]},name:"value"}],return:{name:"string"}}},description:""},renderOption:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  value: T,
  index: number,
  isNew: boolean,
...
) => Partial<StateChangeOptions<T>>`,signature:{arguments:[{type:{name:"DownshiftState",elements:[{name:"T"}],raw:"DownshiftState<T>"},name:"state"},{type:{name:"StateChangeOptions",elements:[{name:"T"}],raw:"StateChangeOptions<T>"},name:"changes"}],return:{name:"Partial",elements:[{name:"StateChangeOptions",elements:[{name:"T"}],raw:"StateChangeOptions<T>"}],raw:"Partial<StateChangeOptions<T>>"}}},description:""},useFixedPositioning:{required:!0,tsType:{name:"boolean"},description:""},getUniqKey:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: T) => string",signature:{arguments:[{type:{name:"T"},name:"item"}],return:{name:"string"}}},description:""},customEmptyListMessage:{required:!1,tsType:{name:"string"},description:""},customNoMatchesMessage:{required:!1,tsType:{name:"string"},description:""},newItemButtonText:{required:!1,tsType:{name:"string"},description:""}}};const G=[{id:"Demo Api Tests",name:"Demo Api Tests"},{id:"Demo Api Tests 1",name:"Demo Api Tests 1"},{id:"Demo Api Tests 2",name:"Demo Api Tests 2"},{id:"Demo Api Tests 3",name:"Demo Api Tests 3"}],M=["Demo Api Tests","Demo Api Tests 1","Demo Api Tests 2","Demo Api Tests 3"],ve={options:G,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e!=null&&e.id?String(e==null?void 0:e.id):"",value:G[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",isDropdownMode:!0,disabled:!1,inputProps:{clearable:!0},maxLength:null},U={options:M,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e?String(e):"",value:M[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",disabled:!1,inputProps:{clearable:!0},maxLength:null},et={title:"Controls/Autocompletes/SingleAutocomplete",component:A,parameters:{...U},tags:["autodocs"]},I={args:{...ve},render:e=>{const[i,r]=W.useState(e.value||{}),m={...e,inputProps:{...e.inputProps,onClear:()=>r({})}},u=(s,n)=>{switch(n.type){case T.stateChangeTypes.keyDownEnter:case T.stateChangeTypes.clickItem:return{...n,highlightedIndex:s.highlightedIndex,inputValue:""};default:return n}},d=s=>{r(s)};return t.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:t.jsx(A,{...m,onChange:d,stateReducer:u,value:i})})}},x={args:{...U},render:e=>{const[i,r]=W.useState(e.value||""),m={...e,inputProps:{...e.inputProps,onClear:()=>r("")}},u=(s,n)=>{switch(n.type){case T.stateChangeTypes.keyDownEnter:case T.stateChangeTypes.clickItem:return{...n,highlightedIndex:s.highlightedIndex,inputValue:""};default:return n}},d=s=>{r(s)};return t.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:t.jsx(A,{...m,onChange:d,stateReducer:u,value:i})})}};var V,B,k;I.parameters={...I.parameters,docs:{...(V=I.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    ...TEST_DATA_OBJECTS
  },
  render: args => {
...
}`,...(K=(H=x.parameters)==null?void 0:H.docs)==null?void 0:K.source}}};const tt=["SingleSelectObjects","SingleSelectStrings"];export{I as SingleSelectObjects,x as SingleSelectStrings,tt as __namedExportsOrder,et as default};
