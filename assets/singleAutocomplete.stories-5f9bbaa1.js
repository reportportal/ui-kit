...
@example menuPortalRoot={document.body}`}}};const Q=[{id:"Demo Api Tests",name:"Demo Api Tests"},{id:"Demo Api Tests 1",name:"Demo Api Tests 1"},{id:"Demo Api Tests 2",name:"Demo Api Tests 2"},{id:"Demo Api Tests 3",name:"Demo Api Tests 3"}],Z=["Demo Api Tests","Demo Api Tests 1","Demo Api Tests 2","Demo Api Tests 3","Demo Api Tests 4","Demo Api Tests 5","Demo Api Tests 6","Demo Api Tests 7","Demo Api Tests 8"],st={options:Q,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e!=null&&e.id?String(e==null?void 0:e.id):"",value:Q[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",isDropdownMode:!0,disabled:!1,inputProps:{clearable:!0},maxLength:null},_={options:Z,loading:!1,async:!0,createWithoutConfirmation:!0,parseValueToString:e=>e?String(e):"",value:Z[0],error:"",touched:!0,minLength:1,placeholder:"Test placeholder",disabled:!1,inputProps:{clearable:!0},maxLength:null},Ot={title:"Controls/Autocompletes/SingleAutocomplete",component:g,parameters:{..._},tags:["autodocs"]},E={args:{...st},render:e=>{const[t,o]=m.useState(e.value||{}),i={...e,inputProps:{...e.inputProps,onClear:()=>o({})}},p=(l,s)=>{switch(s.type){case S.stateChangeTypes.keyDownEnter:case S.stateChangeTypes.clickItem:return{...s,highlightedIndex:l.highlightedIndex,inputValue:""};default:return s}},a=l=>{o(l)};return n.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:n.jsx(g,{...i,onChange:a,stateReducer:p,value:t})})}},O={args:{..._},render:e=>{const[t,o]=m.useState(e.value||""),i={...e,inputProps:{...e.inputProps,onClear:()=>o("")}},p=(l,s)=>{switch(s.type){case S.stateChangeTypes.keyDownEnter:case S.stateChangeTypes.clickItem:return{...s,highlightedIndex:l.highlightedIndex,inputValue:""};default:return s}},a=l=>{o(l)};return n.jsx("div",{style:{width:"600px",height:"400px",display:"flex",alignItems:"center",position:"relative"},children:n.jsx(g,{...i,onChange:a,stateReducer:p,value:t})})}},q={args:{..._,dropdownMatchInputWidth:!0,withMenuFlip:!0,menuPortalRoot:document.body,isDropdownMode:!0},render:e=>n.jsxs("div",{children:[n.jsxs("p",{style:{marginBottom:"16px",maxWidth:"400px"},children:["This example demonstrates menu rendering in a portal to prevent clipping when the autocomplete is inside a container with ",n.jsx("code",{children:"overflow: hidden"})," (e.g., Modal, SidePanel)."]}),n.jsx("div",{style:{width:"400px",height:"80px",overflow:"hidden",border:"2px dashed #aaa",padding:"16px",display:"flex",alignItems:"center"},children:n.jsx(g,{...e})})]})},M={args:{..._,dropdownMatchInputWidth:!0,withMenuFlip:!0,menuPortalRoot:document.body,isDropdownMode:!0},render:e=>n.jsxs("div",{style:{width:"500px",height:"150px",overflow:"auto",border:"2px dashed #aaa",display:"flex",flexDirection:"column",padding:"16px"},children:[n.jsx("div",{style:{width:"400px"},children:n.jsx(g,{...e})}),n.jsx("p",{style:{marginBottom:"16px",maxWidth:"400px"},children:"This is a very long text to enable scrolling. This example demonstrates that the dropdown will close when the user scrolls the page, which is a common UX pattern to prevent the dropdown from being detached from the input. Try scrolling the page to see it in action. So i need to scroll the page to see the effect of the dropdown closing when the user scrolls. This is a very long text to enable scrolling. This example demonstrates that the dropdown will close when the user scrolls the page, which is a common UX pattern to prevent the dropdown from being detached from the input. Try scrolling the page to see it in action. This is a very long text to enable scrolling. This example demonstrates that the dropdown will close when the user scrolls the page, which is a common UX pattern to prevent the dropdown from being detached from the input. Try scrolling the page to see it in action. This is a very long text to enable scrolling. This example demonstrates that the dropdown will close when the user scrolls the page, which is a common UX pattern to prevent the dropdown from being detached from the input. Try scrolling the page to see it in action."})]})};var ee,te,ne;E.parameters={...E.parameters,docs:{...(ee=E.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  args: {
    ...TEST_DATA_OBJECTS
  },
  render: args => {
...
}`,...(le=(ae=q.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var pe,de,me;M.parameters={...M.parameters,docs:{...(pe=M.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  args: {
    ...TEST_DATA_STRINGS,
    dropdownMatchInputWidth: true,
    withMenuFlip: true,
...
}`,...(me=(de=M.parameters)==null?void 0:de.docs)==null?void 0:me.source}}};const qt=["SingleSelectObjects","SingleSelectStrings","SingleSelectWithMenuPortal","SingleSelectWithHideByScroll"];export{E as SingleSelectObjects,O as SingleSelectStrings,M as SingleSelectWithHideByScroll,q as SingleSelectWithMenuPortal,qt as __namedExportsOrder,Ot as default};
