import{j as n}from"./jsx-runtime-2f188e98.js";import{r as m}from"./index-3553ef47.js";import{r as We}from"./index-d0bd1ed5.js";import{c as ke}from"./bind-d8141dee.js";import{D as S}from"./downshift.esm-ce98d9a3.js";import{u as Ge}from"./floating-ui.react-4b64b9af.js";import{F as Ue}from"./fieldText-86ee05b0.js";import{S as Ve}from"./dropdown-1f4530a4.js";import{A as He}from"./autocompleteMenu-fdcd1f8a.js";import{A as Xe,E as Ye,T as Je}from"./constants-1e05cdf5.js";import{i as ze}from"./isEmpty-6ac0b123.js";import{f as Ke,s as $e,b as Qe}from"./floating-ui.react-dom-a5cc5ea5.js";import"./index-4c891f75.js";import"./tslib.es6-e2fc4f1b.js";import"./clear-c7bc24e5.js";import"./openEye-28d4aa93.js";import"./baseIconButton-9b03f096.js";import"./spinLoader-d5daab2a.js";import"./maxValueDisplay-a537ac0f.js";import"./fieldLabel-917daddd.js";import"./index-5cf2ac00.js";import"./bubblesLoader-539cf135.js";import"./button-34bf729b.js";import"./plus-150a0ce8.js";const Ze=({skip:e})=>{m.useLayoutEffect(()=>{if(e)return;let t=window.scrollY,o=!0;const i=300,p=()=>{if(!o)return;window.scrollY!==t&&window.scrollTo(0,t)},a=s=>{o&&(s.preventDefault(),s.stopImmediatePropagation(),p())};t=window.scrollY,window.addEventListener("scroll",a,{passive:!1,capture:!0}),requestAnimationFrame(()=>{t=window.scrollY,p()});const l=setTimeout(()=>{o=!1},i);return()=>{clearTimeout(l),window.removeEventListener("scroll",a,{capture:!0})}},[e])},et=({skip:e,reference:t})=>{m.useEffect(()=>{if(e)return;const o=()=>{const i=t.current;i instanceof HTMLElement&&i.blur()};return window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}},[e,t])},tt=({skip:e,onClose:t,menuRef:o})=>{m.useEffect(()=>{if(e)return;const i=p=>{var a;(a=o.current)!=null&&a.contains(p.target)||t()};return window.addEventListener("scroll",i,!0),()=>{window.removeEventListener("scroll",i,!0)}},[e,t,o])},nt={"input-wrapper":"_input-wrapper_d9vma_1","dropdown-button":"_dropdown-button_d9vma_6","icon-reversed":"_icon-reversed_d9vma_14"},$=ke.bind(nt),ot=0,rt=Ke({fallbackPlacements:["bottom-start","top-start","bottom","top"],boundary:document==null?void 0:document.documentElement,rootBoundary:"viewport"}),st=$e({apply({rects:e,elements:t}){Object.assign(t.floating.style,{width:`${e.reference.width}px`})}}),f=e=>{const{options:t=[],value:o,placeholder:i="",onChange:p=()=>{},onFocus:a=()=>{},onBlur:l=()=>{},disabled:s=!1,inputProps:ue={},parseValueToString:x=r=>r===null?"":String(r),minLength:B=1,skipOptionCreation:ce=!1,maxLength:he=null,optionVariant:ge="",isRequired:fe=!1,error:Te="",touched:we=!1,setTouch:c=()=>{},createWithoutConfirmation:W=!1,menuClassName:ye="",icon:k,isDropdownMode:T=!1,isOptionUnique:R,refFunction:Se,stateReducer:xe,onStateChange:v,useFixedPositioning:ve,dropdownMatchInputWidth:G=!1,withMenuFlip:U=!1,newItemButtonText:be="",menuPortalRoot:h,...Ce}=e,[V,Pe]=m.useState(!1),w=m.useRef(null),Ae=m.useCallback(()=>{var r;return(r=w.current)==null?void 0:r.call(w)},[]),H=!V||!h,X=h||ve?"fixed":"absolute",Ie=!V||X==="absolute",De=m.useMemo(()=>[...U?[rt]:[],...G?[st]:[]],[U,G]),{refs:b,floatingStyles:Ee}=Ge({placement:"bottom-start",whileElementsMounted:Qe,strategy:X,middleware:De});Ze({skip:H}),et({skip:H,reference:b.reference}),tt({skip:Ie,onClose:Ae,menuRef:b.floating});const Oe=(r,u,C)=>({item:y,index:P,...N})=>r({item:y,index:P,isSelected:C!==null&&C===y,...N,isActive:u===P}),Me=(r,u)=>{r.key===Je&&(r.preventDefault(),u(t.length))},_e=m.useCallback((r,...u)=>{(r==null?void 0:r.isOpen)!==void 0&&Pe(r.isOpen),v==null||v(r,...u)},[v]);return n.jsx(S,{onChange:p,itemToString:x,selectedItem:o,onStateChange:_e,defaultHighlightedIndex:ot,stateReducer:xe,children:({getInputProps:r,getItemProps:u,setHighlightedIndex:C,toggleMenu:y,openMenu:P,closeMenu:N,isOpen:g,inputValue:F,highlightedIndex:qe,getRootProps:Re,selectItem:A})=>{const Y=Re(void 0,{suppressRefError:!0}),Ne={...Y,ref:d=>(b.setReference(d),Y.ref(d))};w.current||(w.current=N);const Fe=F??"",{onClear:I,clearable:Le,...je}=ue,J=Le&&o!==null,Be=(...d)=>{A(null),I==null||I(...d)},z=n.jsx(He,{isOpen:g,isDropdownMode:T,style:Ee,ref:b.setFloating,portalMenuAttribute:h?Xe:null,minLength:B,inputValue:(F||"").trim(),getItemProps:Oe(u,qe,o),parseValueToString:x,optionVariant:ge,createWithoutConfirmation:W,className:ye,options:t,newItemButtonText:be,...Ce});return n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:$("input-wrapper"),...Ne,children:[n.jsx(Ue,{...r({placeholder:s?"":i,maxLength:he||void 0,onFocus:()=>{T&&!g&&(P(),c==null||c(!0)),a()},ref:Se,onKeyDown:d=>{d.key===Ye&&d.preventDefault(),F&&g&&Me(d,C)},onBlur:d=>{const D=Fe.trim(),L=!ze(D),K=L?t.find(j=>x(j)===D):void 0;A(K||(!ce&&W&&L?D:null)),l(d),R==null||R(L?!t.some(j=>x(j)===D):null),T&&g&&y(),c==null||c(!0)},disabled:s,defaultWidth:!1,isRequired:fe,touched:we,error:Te,...je,clearable:J,onClear:J?Be:I,endIcon:T&&!k?n.jsx("button",{type:"button",className:$("dropdown-button",{"icon-reversed":g}),onClick:()=>y(),"aria-label":"Toggle dropdown","aria-expanded":g,children:n.jsx(Ve,{})}):k,minLength:T?0:B})}),!h&&z]}),h&&We.createPortal(z,h)]})}})};f.__docgenInfo={description:"",methods:[],displayName:"SingleAutocomplete",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:""},onStateChange:{required:!0,tsType:{name:"ComponentProps['onStateChange']",raw:"ComponentProps<typeof Downshift<T>>['onStateChange']"},description:""},value:{required:!0,tsType:{name:"union",raw:"T | null",elements:[{name:"T"},{name:"null"}]},description:""},placeholder:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"ComponentProps['onChange']",raw:"ComponentProps<typeof Downshift<T>>['onChange']"},description:""},onFocus:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onBlur:{required:!0,tsType:{name:"signature",type:"function",raw:"(e: FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"FocusEvent",elements:[{name:"HTMLInputElement"}],raw:"FocusEvent<HTMLInputElement>"},name:"e"}],return:{name:"void"}}},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},inputProps:{required:!1,tsType:{name:"ComponentProps",elements:[{name:"FieldText"}],raw:"ComponentProps<typeof FieldText>"},description:""},parseValueToString:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: T | null) => string",signature:{arguments:[{type:{name:"union",raw:"T | null",elements:[{name:"T"},{name:"null"}]},name:"value"}],return:{name:"string"}}},description:""},renderOption:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  value: T,
  index: number,
  isNew: boolean,
